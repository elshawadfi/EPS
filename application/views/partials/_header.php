...
<head>
    ...
    <title><?php echo xss_clean($title); ?>  - graduation </title>
...
<?php endforeach; ?>
    ...
    <meta name="twitter:site" content="@<?php echo xss_clean($settings->application_name); ?>"/>
...
<?php endif; endforeach; endif; ?>
    ...
    <!-- Font-icons CSS -->
    <link href="<?php echo base_url(); ?>assets/vendor/font-icons/css/varient-icons.min.css" rel="stylesheet"/>
    <?php echo $primary_font_url; ?>
    <?php echo $secondary_font_url; ?>
    <?php echo $tertiary_font_url; ?>

    <!-- Plugins -->
    <link href="<?php echo base_url(); ?>assets/css/plugins-1.6.css" rel="stylesheet"/>
...
<?php endif; ?>
	<link href="<?php echo base_url(); ?>assets/css/style-1.6.min.css" rel="stylesheet"/>
    <!-- Color CSS -->
<?php if ($vsettings->site_color == '') : ?>
    <link href="<?php echo base_url(); ?>assets/css/colors/default.min.css" rel="stylesheet"/>
<?php else : ?>
    <link href="<?php echo base_url(); ?>assets/css/colors/<?php echo $vsettings->site_color; ?>.min.css" rel="stylesheet"/>
<?php endif; ?>
